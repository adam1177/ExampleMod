...
import evar678.ExampleMod.common.ExampleModCommonProxy;
...
@NetworkMod(clientSideRequired = true, serverSideRequired = true, // Whether
																	...
																	// side are
																	// needed
clientPacketHandlerSpec = @SidedPacketHandler(channels = { "TutorialMod" }, packetHandler = ExampleModClientPacketHandler.class), // For
																																	// clientside
																																	// packet
																																	// handling
serverPacketHandlerSpec = @SidedPacketHandler(channels = { "TutorialMod" }, packetHandler = ExampleModServerPacketHandler.class))
